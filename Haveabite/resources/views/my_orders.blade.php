...
<body>
  ...
  <!--NAVBAR DESIGN-->
    ...
    <div class="container text-center">
        <img src="Images/order.png" style="max-width:40%; margin-right:100px;">
    </div>
    ...
    <div class="container">
        <table class="table table-bordered data-table table-light table-hover" style="width:100%">
            ...
            @php
                $i = 1;
                $foods = DB::table('foods')->where('id', $order->food_id)->get(); 
            ...
            @php
                    $users = DB::table('users')->where('id', $food->seller_id)->get();
            @endphp
